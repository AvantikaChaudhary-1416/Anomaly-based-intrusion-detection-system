...
FLOWS_MODEL_PATH      = os.path.join(MODEL_DIR, "detect_flows_model.joblib")
IP_WINDOWS_MODEL_PATH = os.path.join(MODEL_DIR, "detect_ip_windows_model.joblib")
WINDOWS_MODEL_PATH    = os.path.join(MODEL_DIR, "detect_windows_model.joblib")
...
def on_flow_closed(record):
    ...
    win_hit = _lookup_window(record.get('window_start_ts'),recent_window_scores)
